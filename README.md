...
- Edit config.php.
- Open translate.php in your browser, start editing and save at the end.
...
- User input is not filtered! It's *not* recommended to keep this translate.php accessible for everyone.
...
- Run ```./vendor/bin/phpcs translate.php```
- Run ```./vendor/bin/phpcs translate.php --standard=PSR12```
- Run ```./vendor/bin/phpcs -p translate.php --standard=PHPCompatibility --runtime-set testVersion 4.0-```
